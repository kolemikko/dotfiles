...
#+begin_src sh :tangle ../.config/polybar/cpu-temp.sh :mkdirp yes :shebang "#!/bin/sh"
  sensors | grep "CPU:" | grep "+" | tr -d '+' |  awk '{print $2}'
#+end_src
...
#+begin_src sh :tangle ../.config/polybar/config :mkdirp yes
  ...
  modules-center =
  modules-right = pulseaudio wlan cpu-temp battery
